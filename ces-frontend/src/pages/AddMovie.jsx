...
const emptyForm = {
  ...
  castMembers: '', status: 'Currently Running', releaseDate: '',
};
...
const AddMovie = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (!form.status) {
      return setMessage({ type: 'error', text: 'Status is required.' });
    }
  ...
  return (
    <div style={{ maxWidth: '520px', margin: '40px auto', fontFamily: 'Arial', padding: '0 20px' }}>
      ...
      <label>Rating</label>
      <input style={input} value={form.rating} onChange={set('rating')} placeholder="PG-13" />
